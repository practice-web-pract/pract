(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-main-block__slider")) new swiper_core_Swiper(".slider-main-block__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            navigation: {
                prevEl: ".slider-main-block-left",
                nextEl: ".slider-main-block-right"
            },
            on: {}
        });
        if (document.querySelector(".projects__body-slider")) new swiper_core_Swiper(".projects__body-slider", {
